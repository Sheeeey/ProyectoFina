	...
	<form method="post">
		...
		<?php
			if (isset($_POST['send'])){
				...
				$mail_username="mgomezmanjon@gmail.com";//Correo electronico saliente ejemplo: tucorreo@gmail.com
				$mail_userpassword="d14d8i24";//Tu contraseña de gmail
				$mail_addAddress="hugo10040608@gmail.com";//correo electronico que recibira el mensaje
